...
public class DeviceOperationController {
    ...
    public AjaxResult controlDevice(@RequestBody DeviceControlRequest request) {
        ...
        int index = request.getIndex() == null ? 0 : request.getIndex();
        ...
        if (index == 0) {
            ...
            if ("on".equalsIgnoreCase(action)) {
                ...
                int resultOn = serialPortService.writeToSerial(hexStringToByteArray(onCommand1));
                if (resultOn <= 0) {
                ...
                new Thread(() -> {
                    try {
                        ...
                        serialPortService.writeToSerial(hexStringToByteArray(offCommand1));
                ...
                int resultOff = serialPortService.writeToSerial(hexStringToByteArray(onCommand2));
                if (resultOff <= 0) {
                ...
                new Thread(() -> {
                    try {
                        ...
                        serialPortService.writeToSerial(hexStringToByteArray(offCommand2));
                    } catch (InterruptedException e) {
